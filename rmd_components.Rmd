...
.larger[
- **`knitr`**: Embedding R code & results computed from it in a Markdown document.
...
.footnote[
[說明文件](https://yihui.name/knitr/options/)
]
...
- 可同時設定多個輸出格式
    - 第一個： 點擊 <img src='img/knitr.png' style='display:inline;height:1em;'> 後所輸出之格式
]
